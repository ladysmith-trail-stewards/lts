...
export const TRAIL_COLOR_EXPR: ExpressionSpecification = [
  ...
  // difficulty palette
  ['==', ['get', 'trail_class'], 'ACCESS'],       '#8b5aa6',
  ['==', ['get', 'trail_class'], 'PATH'],         '#f1efe8',
  ['==', ['get', 'trail_class'], 'EASIEST'],      '#6fbf4b',
  ['==', ['get', 'trail_class'], 'EASY'],         '#6fbf4b',
  ['==', ['get', 'trail_class'], 'INTERMEDIATE'], '#2f80ed',
  ['==', ['get', 'trail_class'], 'BLACK'],        '#1e293b',
  ['==', ['get', 'trail_class'], 'DOUBLE_BLACK'], '#ef4444',
  ['==', ['get', 'trail_class'], 'SECONDARY'],    '#f1efe8',
  ['==', ['get', 'trail_class'], 'PRO'],          '#fb923c',
  ['==', ['get', 'trail_class'], 'ADVANCED'],     '#818cf8',
  ['==', ['get', 'trail_class'], 'LIFT'],         '#fde68a',
  ['==', ['get', 'trail_class'], 'IMBY'],         '#94a3b8',
  ['==', ['get', 'trail_class'], 'TBD'],          '#cbd5e1',
  '#cbd5e1',
];

export const TRAIL_WIDTH_EXPR: ExpressionSpecification = [
  'case',
  ['==', ['get', 'hidden'],    true], BASE_WIDTH * 0.25,
  ['==', ['get', 'connector'], true], BASE_WIDTH * 0.75,
  BASE_WIDTH,
];
...
export const TRAIL_HALO_WIDTH: ExpressionSpecification = [
  'case',
  ['==', ['get', 'hidden'],    true], BASE_WIDTH * 0.25 + 1,
  ['==', ['get', 'connector'], true], BASE_WIDTH * 0.75 + 1,
  BASE_WIDTH + 1,
];
...
export const CONTOUR_COLORS = {
  dark:  { major: '#4a3828', semi: '#6b5240', minor: '#8a6e58', label: '#4a3828' },
  light: { major: '#c4b8ac', semi: '#d4cbc3', minor: '#e2dbd5', label: '#a89888' },
} as const;
